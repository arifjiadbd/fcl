...
export default function RecordsPage() {
  ...
  const mostMom = [...players].sort((a, b) => (b.mom || 0) - (a.mom || 0)).slice(0, 5);
  const mostMot = [...players].sort((a, b) => (b.mot || 0) - (a.mot || 0)).slice(0, 5);
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-white selection:bg-[#f59e0b]/30 selection:text-white">
      ...
      {/* ================================================== */}
      {/* 🌟 GRAND SPOTLIGHT: TOP 3 ALL-TIME LEGENDS (আলিশান পোডিয়াম) */}
      {/* ================================================== */}
...
{/* View Full Leaderboard Callout Button */}
              ...
              <div>
                <div className="mb-5 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-[#64748b]">Tournament champions, final appearances, MOM & MOT kings</p>
                  </div>
                </div>
                ...
                <div className="grid gap-5 md:grid-cols-3">
                  ...
                  <div className="rounded-3xl border border-[#1e293b] bg-[#0b1220] p-5">
                    <div className="flex items-center justify-between border-b border-[#172033] pb-3">
                      <span className="text-xs font-black uppercase tracking-wider text-[#60a5fa]">MOM Awards 🎖️</span>
                      <span className="text-[10px] text-[#64748b]">MOM</span>
                    </div>
                    <div className="mt-3 divide-y divide-[#172033]/60">
                      {mostMom.map((p, idx) => (
                        <div
                        ...
                        >
                          <div className="flex items-center gap-2.5">
                            <span className="text-xs font-bold text-[#64748b]">{idx + 1}.</span>
                            <p className="text-xs font-bold text-white group-hover:text-[#60a5fa] line-clamp-1">{p.name}</p>
                          </div>
                          <span className="text-xs font-black text-[#60a5fa]">{p.mom ?? 0}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                ...
                <div className="rounded-2xl border border-[#f59e0b]/40 bg-gradient-to-r from-[#171103] via-[#211603] to-[#171103] p-2.5 sm:p-3 text-center">
                  ...
                  <div className="mt-2 grid grid-cols-4 gap-2 text-center text-xs">
                    ...
                    <div className="rounded-xl bg-black/40 p-1.5 border border-[#f59e0b]/20">
                      ...
                      <p className="font-black text-[#38bdf8] mt-0.5">
      ...
      <footer className="border-t border-[#1e293b] bg-[#020617] px-6 py-8">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 text-center md:flex-row md:text-left">
          ...
          <p className="text-xs text-[#64748b]">© 2026 FCL All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
